...
function resultado()
{
    ...
    if(Number(x) == 1) //hertz selecionado
    {
        var valor = document.getElementById('valor').value;
        r1.innerHTML = `${Number(valor)} hertz equivale a: ${(Number(valor) / 1000000)} megahertz`
        r2.innerHTML = `${Number(valor)} hertz equivale a: ${(Number(valor) / 1000000000)} gigahertz`
    }
    else if(Number(x) == 2)//megahertz selecionado
    {
        var valor = document.getElementById('valor').value;
        r1.innerHTML = `${Number(valor)} megahertz equivale a: ${(Number(valor) * 1000000)} hertz`
        r2.innerHTML = `${Number(valor)} megahertz equivale a: ${(Number(valor) / 1000)} gigahertz`
    }
    else //gigahertz selecionados
    {
        var valor = document.getElementById('valor').value;
        r1.innerHTML = `${Number(valor)} gigahertz equivale a: ${(Number(valor) * 1000000000)} hertz`
        r2.innerHTML = `${Number(valor)} gigahertz equivale a: ${(Number(valor) * 1000)} megahertz`
    }
